    ...
    module V1
      ...
      class CreateRecord
        ...
        def structure_errors(result)
          warnings = %i[medicaid_id suffix sexual_orientation first_name_alt last_name_alt middle_name suffix admission_id service_request_date criminal_justice_referral health_insurance]
