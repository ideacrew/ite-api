    ...
    module V1
      ...
      class CreateRecord
        ...
        def structure_errors(result)
          ...
          critical_error_fields = %i[employment education legal_status primary_language ethnicity race first_name last_name dob gender self_help_group_discharge arrests_past_30days_discharge num_of_prior_su_episodes discharge_reason referral_source living_arrangement]
